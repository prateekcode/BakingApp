...
import com.androidmonk.myapplication.adapter.DetailsAdapter;
...
public class DetailActivity extends AppCompatActivity implements StepsFragment.OnStepClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isTablet){
            ...
            DetailsAdapter detailPagerAdapter = new DetailsAdapter(this,
    ...
    private void displayImage() {
        ...
        if (imageUrl.isEmpty()) {
            switch (recipe.getmId()) {
                case 1:
                    recipeImage.setImageResource(R.drawable.nutellapie);
                    break;
                case 2:
